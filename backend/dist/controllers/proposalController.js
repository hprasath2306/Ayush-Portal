...
export const getEveryProposals = async (req, res) => {
    try {
        const proposals = await prisma.proposal.findMany();
        res.json(proposals);
    }
...
export const createProposal = async (req, res) => {
    try {
        const { fullName, email, problemDescription, ideaDescription, investmentAmount, pitchVideoUrl, additionalInfo } = req.body;
